...
public class SetEmployeeComparator {
  ...
  public static void main(String[] args) {
    ...
    t1.add(e5);
    System.out.println(
        t1); //[{eid=10, name='Summer'}, {eid=100, name='John'}, {eid=150, name='Anna'}, {eid=200, name='Morty'}, {eid=250, name='Emma'}]
    ...
    t2.add(e5);
    System.out.println(
        t2); // [{eid=150, name='Anna'}, {eid=250, name='Emma'}, {eid=100, name='John'}, {eid=200, name='Morty'}, {eid=10, name='Summer'}]
