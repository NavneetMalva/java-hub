...
public class MapEx04TreeMap {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Checking the entry for 30: ");
    System.out.println(
        "Key(s): " + tree_map.headMap(30, true)); // Key(s): {10=Red, 20=Green, 30=Black}
    ...
    SortedMap<Integer, String> sub_tree_map2;
    System.out.println("Original TreeMap content: "
        + tree_map); // {20=Green, 30=Black, 40=White, 50=Orange, 60=Pink}
    sub_tree_map = tree_map.subMap(20, 40);
    System.out.println("Sub map key-values: "
        + sub_tree_map); // Sub map key-values Exclusive: {20=Green, 30=Black}
