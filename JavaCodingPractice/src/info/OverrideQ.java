...
public class OverrideQ extends A {
  ...
  /**
   * In this case, methodB in OverrideQ is not an example of overriding. This is because static
   * methods in Java are not polymorphic; they belong to the class in which they are defined, not to
