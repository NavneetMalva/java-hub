...
/**
 * a ConcurrentModificationException can occur on maps without using multiple threads.
 * This happens when you modify the map while iterating over it using an iterator
...
/**
 * Solution
 * To avoid this exception, use one of the following options:
 *
