 ...
 * The clone() method in Java is defined in the Object class and is used to create a copy of an object.
 * For an object to be cloned:
 * The class of the object must implement the Cloneable interface.
 * The clone() method should be overridden and made public in the class because it is protected in Object.
 */
