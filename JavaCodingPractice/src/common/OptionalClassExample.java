...
/**
 * Optional class (introduced in Java 8) is a container object which may or may not contain a
 * non-null value. The main purpose of Optional is to help avoid NullPointerException by providing a
 * way to express the possible absence of a value without using null.
 */
