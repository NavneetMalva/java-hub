...
/**
 * The Box class can only work with objects that are both a subclass of Number and implement the Printable interface.
 * This ensures that the objects it handles are numeric and can also be printed.
 *
