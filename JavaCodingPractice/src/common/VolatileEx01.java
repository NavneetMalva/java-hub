...
/**
 * In Java, the volatile keyword is used to indicate that a variable's value may be modified by multiple threads.
 * When a variable is declared as volatile, it ensures that updates to the variable are immediately visible to all threads.
 * This prevents threads from caching the variable locally, forcing them to read it directly from main memory every time it’s accessed.
 */
