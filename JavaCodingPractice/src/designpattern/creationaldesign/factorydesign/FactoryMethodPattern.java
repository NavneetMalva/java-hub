 ...
 * provides an interface for creating objects in a superclass while allowing subclasses to specify
 * the types of objects they create.
 * <p>
 * This pattern simplifies the object creation process by placing it in a dedicated method,
 * promoting loose coupling between the object creator and the objects themselves. This approach
 * enhances flexibility, extensibility, and maintainability, enabling subclasses to implement their
 * own factory methods for creating specific object types.
 */
