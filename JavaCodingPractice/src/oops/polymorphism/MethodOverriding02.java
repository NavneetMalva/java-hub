 ...
 * <p>
 * if Parent public -> child Public protected -> protected/public default ->
 * default/protected/public private -> overriding does not happen for private methods.
 * <p>
...
/**
 * since method m1 is static, It can not be override in C1 It is not overriding in C1, method m1 in
 * C1 is independent to method m1 in P1 hence we can't annotate with @Override m1 in C1.
 */
...
/**
 * We can't reduce scope of modifier But we can increase scope
 */
